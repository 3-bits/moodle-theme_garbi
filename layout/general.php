...
<head>
    ...
    <script src="<?php echo $CFG->wwwroot;?>/theme/garbi/jquery/jquery.flexslider.js"></script>
...
<!-- START Front Page Slideshow -->
    ...
    <ul class="slides">
        <li>
            <img src="<?php echo $PAGE->theme->settings->slide1;?>" />
        </li>
        <li>
            <img src="<?php echo $PAGE->theme->settings->slide2;?>" />
        </li>
        <li>	
            <img src="<?php echo $PAGE->theme->settings->slide3;?>" />
        </li>
    </ul>
    </div>
